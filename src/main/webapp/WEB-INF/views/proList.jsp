    ...
    <div class="container">
      <div class="masthead">
        ...
        <ul class="nav nav-justified">
          <li id="lg"  class="active"><a href="javascript:void(0);" onclick="fun_show(this,'nav1')">企业-功能专区</a></li>
          <li id="lc"><a href="javascript:void(0);" onclick="fun_show(this,'nav2')">企业-产品专区</a></li>
          <li id="lcx"><a href="javascript:void(0);" onclick="fun_show(this,'nav3')">程序员-工具包</a></li>
